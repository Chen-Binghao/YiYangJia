...
public class LoginModel extends BaseModel implements LoginContract.Model {
    ...
    public void saveUser(final LoginUserBean user, final InfoHint infoHint){
        ...
        spUtils.put("cal",String.valueOf(user.getCal()));
        spUtils.put("pro",String.valueOf(user.getPro()));
        spUtils.put("fat",String.valueOf(user.getFat()));
        spUtils.put("ch2o",String.valueOf(user.getCh2o()));
        spUtils.put("notice","0");
