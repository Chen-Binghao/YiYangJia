...
public class SettingPresenter extends BasePresenter<SettingActivity> implements SettingContract.Presenter {
    ...
    public void updateInfo(String tel, final String oldNickname, final String nickname, final String birthday,
                           final String gender, final String height, final String weight, final String cal, final String pro, final String fat, final String ch2o) {
        model.updateInfo(tel, nickname, birthday, gender, height, weight, cal, pro, fat, ch2o, new SettingContract.Model.InfoHint() {
            @Override
